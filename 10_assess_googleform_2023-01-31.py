...
def get_list_of_fators_not_implemented(
    results, column_number_suggested, column_number_implemented
):
...
assess_number_of_mentions(
    df_answers_doi, name=f"{columns[assessed_column][:2]}-Output-Indicators-Implemented"
)
print("\n")
...
df_answers_doi = get_list_of_fators_not_implemented(
...
df_answers_doi = get_list_of_fators_not_implemented(
    results, column_number_suggested=46, column_number_implemented=56
)
assess_number_of_mentions(
    df_answers_doi, name=f"{columns[46][:2]}-Output-Indicators-Not-Implemented"
)
print("\n")
...
assess_number_of_mentions(
    df_answers_doi, name=f"{columns[assessed_column][:2]}-Used-Methods"
)
print("\n")
